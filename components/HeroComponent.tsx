...
const HeroComponent = async ({ title, description, className, children }: Props) => {
  const categories = await getAllCategories();

  return (
    <section className={`relative bg-[url('/hero.jpeg')] bg-cover bg-center bg-no-repeat md:h-[400px] ${className}`}>
      {/* Overlay */}
